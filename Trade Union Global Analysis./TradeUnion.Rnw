...
# wrap and edit title
title_text <- "Time Series Analysis of Union Density in the United States"
...
title_text <- "Time Series Analysis of Union Density in the United States Northern States are Highlighted"
wrapped_title <- str_wrap(title_text, width = 30)
...
title_text <- "Time Series Analysis of Union Density in the United States Southern States are Highlighted"
wrapped_title <- str_wrap(title_text, width = 30)
